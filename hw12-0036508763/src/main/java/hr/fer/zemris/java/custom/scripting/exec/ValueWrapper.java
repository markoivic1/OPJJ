...
public class ValueWrapper {
    ...
    public int numCompare(Object withValue) {
        ...
        Object result = doOperation(this, withValue, (v1,v2) -> v1 - v2);
    ...
    private Double convertToDouble(Object value) {
        ...
        if (value instanceof ValueWrapper) {
            return Double.parseDouble(((ValueWrapper) value).getValue().toString());
        }
    ...
    private boolean isDouble(Object value) {
        ...
        if (value.getClass() == ValueWrapper.class) {
            return ((ValueWrapper) value).getValue() instanceof Double;
        }
        String valueAsString = value.toString();
    ...
    private void throwExceptionIfNotSupported(Object value) {
        ...
        if ((value.getClass() == Integer.class) ||
                ...
                (value.getClass() == ValueWrapper.class)) {
            return;
        }
