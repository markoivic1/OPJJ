...
class ArrayIndexedCollectionTest {
    ...
    ArrayIndexedCollection sourceCollection;
    String message;
    ...
    public void constructorWithInitialCapacity() {
        ...
        ArrayIndexedCollection collectionWithInitalCapacity = new ArrayIndexedCollection(2);
        String messageStoredInCollection = "This is not a drill!";
        collectionWithInitalCapacity.add("T");
        collectionWithInitalCapacity.add("h");
        collectionWithInitalCapacity.add("i");
        collectionWithInitalCapacity.add("s");
        collectionWithInitalCapacity.add(" ");
        collectionWithInitalCapacity.add("i");
        collectionWithInitalCapacity.add("s");
        collectionWithInitalCapacity.add(" ");
        collectionWithInitalCapacity.add("n");
        collectionWithInitalCapacity.add("o");
        collectionWithInitalCapacity.add("t");
        collectionWithInitalCapacity.add(" ");
        collectionWithInitalCapacity.add("a");
        collectionWithInitalCapacity.add(" ");
        collectionWithInitalCapacity.add("d");
        collectionWithInitalCapacity.add("r");
        collectionWithInitalCapacity.add("i");
        collectionWithInitalCapacity.add("l");
        collectionWithInitalCapacity.add("l");
        collectionWithInitalCapacity.add("!");
        assertTrue(collectionElementsMatchTheMessage(collectionWithInitalCapacity, messageStoredInCollection));
    }

    @Test
    public void constructorThatUsesExistingArray() {
        // This test takes existing ArrayIndexedCollection and uses it as an argument
        ArrayIndexedCollection collectionWhichTakesExistingCollection = new ArrayIndexedCollection(collection);
        // If collection doesn't match the message the test should fail.
    ...
    public void constructorThatTakesExistingCollectionAndInitialCapacity() {
        ArrayIndexedCollection collectionWithSizeLowerThanNeeded = new ArrayIndexedCollection(collection, 10);
        ArrayIndexedCollection collectionWithSizeGreaterThanNeeded = new ArrayIndexedCollection(collection, 30);
    ...
    public void constructorThatTakesNullValueAndInitialCapacity() {
        try {
            ArrayIndexedCollection collectionWithNullValue = new ArrayIndexedCollection(null, 10);
    ...
    void eachCollectionElementAddedToString() {
        ArrayIndexedCollection collectionObjectsAreAddedTo = new ArrayIndexedCollection();
    ...
    void collectionContainsElement() {
        ArrayIndexedCollection collectionOfLetters = new ArrayIndexedCollection();
        class LetterWrapper {
        ...
        //Object objectNotFromCollection = (Object) objectNotContainedInCollection;
    ...
    void clearACollection() {
        ...
        ArrayIndexedCollection collectionWithSingleElement = new ArrayIndexedCollection(1);
    ...
    void insertToACollectionWithSomeElements() {
        ArrayIndexedCollection filledCollection = new ArrayIndexedCollection(3);
    ...
    void indexOfObjectInCollection() {
        ArrayIndexedCollection collectionThatContainsObject = new ArrayIndexedCollection();
    ...
    void indexOfObjectThatIsNotInTheCollection() {
        ArrayIndexedCollection collectionThatDoesntContainObject = new ArrayIndexedCollection();
    ...
    void removeObjectFromCollectionWithAnIndex() {
        ArrayIndexedCollection collectionThatNeedsObjectRemoved = new ArrayIndexedCollection(4);
