...
/**
 * Class used to test ArrayIndexedCollection and LinkedListIndexedCollection.
 */
public class CollectionsDemo {

    /**
     * Predefined method used to test correct implementations of some methods which are used in {@link ArrayIndexedCollection} and {@link LinkedListIndexedCollection}.
     */
    public static void main(String[] args) {
        ...
        Processor P = (o) -> System.out.println(o);
