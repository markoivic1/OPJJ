...
public class Dictionary<K,V> {
    ...
    public void put(K key, V value) {
        Objects.requireNonNull(key);
        DictionaryEntry dictionaryEntry = checkIfKeyExistsAndReturnEntry(key);
     ...
     */
    private DictionaryEntry checkIfKeyExistsAndReturnEntry(Object key) {
        ...
        while (entryElementsGetter.hasNextElement()) {
            DictionaryEntry dictionaryEntry = entryElementsGetter.getNextElement();
